...
- **Épicerie, immagini gestibili**: aggiunti slot `site_epicerie_hero` (Hero) e riorganizzata la foto di presentazione. Il tab Épicerie ha ora: Hero, Présentation, Galerie produits. La « Photo présentation » usa lo slot esistente `site_disc_epicerie` (spostato dal tab Accueil al tab Épicerie; stessa immagine del teaser Épicerie in home, letta per chiave da Decouvrir).
